const { getAll, getOne, create, update, remove, login, validate_token, refresh_token } = require("../controller/users.controller.js");
...
const users = (app) => { 
    ...
    app.post("/api/users/refresh-token", refresh_token);
}; 
